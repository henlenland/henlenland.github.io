function nav(){
    ...
    header.innerHTML = `<a class="el" href="/wiki/"><b>HenleneWiki</b></a><span style="float: right;" class="el"><input type="text" placeholder="Поиск в HenleneWiki" id="searchText" onChange="window.location.href = \`/wiki/search?id=\$\{document.getElementById('searchText').value\}\`"></span>`
